...
\begin{frame}[t]{}
    ...
    \begin{beamercolorbox}[wd=\textwidth,sep=1em]{banner}
        \bf
        \begin{center}
            {\includegraphics[width=0.55\paperwidth]{figures/koopmans_white_on_transparent.png}}
            ...
            \vspace{-1em}
            \LARGE
            \emph{an open-source package for accurately predicting spectral properties}
    ...
    \begin{beamercolorbox}[ht=0.776\paperheight,wd=\textwidth]{background}
        ...
        \begin{columns}[t]
            ...
            \begin{column}{0.47\textwidth}
                ...
                \vspace{1em}
                \setbeamercolor{block title}{bg=kgrey, fg=white}
                \begin{block}{References, acknowledgements, and affiliations}
                    \vspace{0.4em}
                    \hspace{-2em}
